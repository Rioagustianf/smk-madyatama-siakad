...
export const activitiesPrismaRepository: ActivitiesRepository = {
  ...
  create(payload: any) {
    return prisma.activity.create({ data: { ...payload, createdAt: new Date(), updatedAt: new Date() } });
  },
  update(id: string, payload: any) {
    return prisma.activity.update({ where: { id }, data: { ...payload, updatedAt: new Date() } });
  },
